const SponsorLogin = {
  template: `
    ...
    <img src="/static/img/spon.jpg" alt="Admin" style="width: 100%; max-width: 400px; display: block; margin: 0 auto;">
      <h2>Login to Brandifiers-Sponsors</h2>
      ...
      fetch('/login/sponsor', {
        ...
        .then(data => {
          if (data.access_token) {
            ...
            this.$router.push('/sponsorpage');   // Redirect to influencer profile
          } else {
